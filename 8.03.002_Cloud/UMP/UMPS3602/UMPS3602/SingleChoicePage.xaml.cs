    ...
    public partial class SingleChoicePage
    {
        ...
        private bool LoadFiles()
        {
            try
            {
                ...
                client = new Service36021Client(WebHelper.CreateBasicHttpBinding(CurrentApp.Session), WebHelper.CreateEndpointAddress(CurrentApp.Session.AppServerInfo, "Service36021"));
