...
namespace UMPS3602
{
    ...
    public partial class AddPaperPage
    {
        ...
        private bool SetPaperInfo()
        {
            ...
            {
                StrName = TbPaperName.Text,
                StrDescribe = TbDescribeConnect.Text
            };
        ...
        {
            if (Convert.ToInt32(TbPassMark.Text) < 0 || Convert.ToInt32(TbPassMark.Text) > 500)
            {
        ...
        private bool CheckAllText()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(TbDescribeConnect.Text))
                {
                ...
                if (Convert.ToInt32(TbPassMark.Text) < 10 || Convert.ToInt32(TbPassMark.Text) > 500)
                {
                    ShowException(CurrentApp.GetLanguageInfo("3602T00159", "Exam qualification points set range (10-500)"));
                    return false;
                }
