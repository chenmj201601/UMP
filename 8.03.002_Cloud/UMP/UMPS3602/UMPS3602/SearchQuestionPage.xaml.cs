...
namespace UMPS3602
{
    ...
    public partial class SearchQuestionPage
    {
        ...
        public SearchQuestionPage()
        {
            ...
            _mListCategoryTreeParam = S3602App.GLstCCategoryTrees;
        ...
        {
            base.ChangeLanguage();
            SearchCategoryName.Text = CurrentApp.GetLanguageInfo("3602T00124", "Choice Category");
            SearchInfoName.Text = CurrentApp.GetLanguageInfo("3602T00125", "Question Infornation");
            TypeName.Text = CurrentApp.GetLanguageInfo("3602T00126", "Question Type");
            UseNumName.Text = CurrentApp.GetLanguageInfo("3602T00027", "used Number");
            TrueOrFalseName.Content = CurrentApp.GetLanguageInfo("3602T00098", "True Or False");
            SingleChioceName.Content = CurrentApp.GetLanguageInfo("3602T00097", "Single Chioce");
            MultipleChoiceName.Content = CurrentApp.GetLanguageInfo("3602T00099", "Multiple Choice");
            CreateTime.Text = CurrentApp.GetLanguageInfo("3602T00032", "Create Time");
            OkButton.Content = CurrentApp.GetLanguageInfo("3602T00068", "OK");
            BtnCancel.Content = CurrentApp.GetLanguageInfo("3602T00069", "Cancel");
        ...
        private void TbUseNumMin_OnValueChanged(object sender, RoutedPropertyChangedEventArgs<object> e)
        {
             try
            {
                ...
                {
                    ShowInformation(CurrentApp.GetLanguageInfo("3602T00186", "Numerical range of 0-10000"));
                }
            }
            catch
            {
        ...
        private bool CheckUseNumText()
        {
            try
            {
                ...
                {
                    ShowInformation(CurrentApp.GetLanguageInfo("3602T00187", "Use the number fill in error! Please check the following fill out again!"));
                    return false;
                }
            }
            catch (Exception)
        ...
        private void TxtSearchInfo_OnTextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            {
                ShowInformation(CurrentApp.GetLanguageInfo("3602T00185", "The subject content query cannot exceed 128 characters."));
            }
        }
    }
}
