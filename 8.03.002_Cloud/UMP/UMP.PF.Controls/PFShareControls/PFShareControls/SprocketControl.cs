...
namespace PFShareControls
{
    public class SprocketControl : Control
    {
        ...
        private double alphaChange = 0;
        private double angleIncrement = 0;
        private double renderStartAngle = 0;
        ...
        /// indicates whether the SprocketControlControl's progress is indeterminate or not.
        /// </summary>
        ...
        /// indicates the direction of Rotation of the SprocketControlControl.
        /// </summary>
        ...
        /// indicates the color of the Spokes in the SprocketControlControl.
        /// </summary>
        ...
        /// indicates the number of spokes of the SprocketControlControl.
        /// </summary>
        ...
        public static readonly DependencyProperty TickStyleProperty =
            DependencyProperty.Register("TickStyle", typeof(PenLineCap), typeof(SprocketControl),
                new FrameworkPropertyMetadata(PenLineCap.Round, FrameworkPropertyMetadataOptions.AffectsRender,
                    (new PropertyChangedCallback(OnTickStyleChanged))));
        ...
        /// indicates the width of each spoke in the SprocketControlControl.
        /// </summary>
        ...
        public SprocketControl()
        {
            ...
            // Set the minimum size of the SprocketControlControl
        ...
        private void CalculateSpokesPoints()
        {
            ...
            {
                Point pt1 = new Point(innerRadius * (float)Math.Cos(ConvertDegreesToRadians(angle)),
                    innerRadius * (float)Math.Sin(ConvertDegreesToRadians(angle)));
                Point pt2 = new Point(outerRadius * (float)Math.Cos(ConvertDegreesToRadians(angle)),
        ...
        protected override void OnRender(DrawingContext dc)
        {
            ...
            for (int i = 0; i < TickCount; i++)
            {
                ...
                Pen p =
                    new Pen(
                        new SolidColorBrush(Color.FromArgb(alpha, this.TickColor.R, this.TickColor.G, this.TickColor.B)),
                        TickWidth);
