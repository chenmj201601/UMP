...
{
    public class S5100EncryptOperation
    {
        ...
        public static string DecryptLL256(string AStrSource)
        {
            ...
            byte[] LByteArrayKey256Low1 = Encoding.ASCII.GetBytes(S5100Const.VCT_KEY256_LOW1);
            byte[] LByteArrayAexIv = Encoding.ASCII.GetBytes(S5100Const.VCT_ENCRYPTION_AES_IVEC_LOW);
