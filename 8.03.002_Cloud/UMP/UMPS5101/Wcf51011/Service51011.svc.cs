...
namespace Wcf51011
{
    // 注意: 使用“重构”菜单上的“重命名”命令，可以同时更改代码、svc 和配置文件中的类名“Service51011”。
    // 注意: 为了启动 WCF 测试客户端以测试此服务，请在解决方案资源管理器中选择 Service51011.svc 或 Service51011.svc.cs，然后开始调试。
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Required)]
    public class Service51011 : IService51011
    {
        ...
        private OperationReturn OptAddKwContent(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                string strSql = "SELECT * FROM T_51_007";
        ...
        private OperationReturn OptAddKeyword(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                string strSql = "SELECT * FROM T_51_006";
                IDbConnection objConn;
                IDbDataAdapter objAdapter;
                DbCommandBuilder objCmdBuilder;
                switch (session.DBType)
        ...
        private OperationReturn OptUpdateKwContent(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                string rentToken = session.RentInfo.Token;
                string strSql = string.Format("SELECT * FROM T_51_007  where c001='{0}' ", param.LongKwContentNum);
                IDbConnection objConn;
                IDbDataAdapter objAdapter;
                DbCommandBuilder objCmdBuilder;
                switch (session.DBType)
        ...
        private OperationReturn OptSelectAssignKwContent(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                {
                    strSql = string.Format("select * from T_51_007 where c001='{0}' and c008='0' and c003='1'", assparam.LongKwConNum);
                    switch (session.DBType)
                    {
                        case 2:
                            optReturn = MssqlOperation.GetDataSet(session.DBConnectionString, strSql);
        ...
        private OperationReturn OptUpdate51008(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                {
                    string strSql = string.Format("SELECT * FROM T_51_008  where c001='{0}' ", associationTableParam.LongKwConNum);
                    IDbConnection objConn;
                    IDbDataAdapter objAdapter;
                    DbCommandBuilder objCmdBuilder;
                    switch (session.DBType)
        ...
        private OperationReturn OptUpdateKw(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                string rentToken = session.RentInfo.Token;
                string strSql = string.Format("SELECT * FROM T_51_006  where c001='{0}' ", param.LongKwNum);
                IDbConnection objConn;
                IDbDataAdapter objAdapter;
                DbCommandBuilder objCmdBuilder;
                switch (session.DBType)
            ...
            try
            {
                ...
                switch (webRequest.Code)
                {
                    ...
                    case (int)RequestCode.WSGetSerialID:
                        ...
                        break;
                    case (int)S5101Codes.OptAddKwContent:
                        ...
                        break;
                    case (int)S5101Codes.OptSelectKwContent:
                        ...
                        break;
                    case (int)S5101Codes.OptUpdateKwContent:
                        ...
                        break;
                    case (int)S5101Codes.OptDeleteKwContent:
                        ...
                        break;
                    case (int)S5101Codes.OptAddKeyword:
                        ...
                        break;
                    case (int)S5101Codes.OptSelectKeyword:
                        ...
                        webReturn.ListData = optReturn.Data as List<string>;
                        break;
                    case (int)S5101Codes.OptSelectAssignKwContent:
                        ...
                        webReturn.ListData = optReturn.Data as List<string>;
                        break;
                    case (int)S5101Codes.OptUpdate51008:
                        ...
                        break;
                    case (int)S5101Codes.OptUpdateKw:
                        ...
                        break;
                    case (int)S5101Codes.OptDeleteKw:
                        ...
                        break;
                    case (int)S5101Codes.OptClearKwContent:
