            ...
            try
            {
                ...
                for (int i = 0; i < dsAll.Tables.Count; i++)
                {
                    ...
                    foreach (DataRow row in dsAll.Tables[i].Rows)
                    {
                        ...
                        contacter.UserName = row["UserName"].ToString();
                        contacter.FullName = row["FullName"].ToString();
                        contacter.OrgName = row["OrgName"].ToString();
                ...
                switch (session.DBType)
                {
                    case 2:
                        strSql = "select a.C001 UserID,a.C002 UserName,a.C003 FullName,b.C002 OrgName,c.C015 as OnlineStatus,b.C001 as OrgID,b.C004 as ParentOrgID  " +
                                        "FROM t_11_005_{0} a left join t_11_006_{1} b " +
                                        "on a.C006 = b.C001  left join T_11_101_{2} as c  on a.C001 =  c.C001 " +
                                        ...
                                        "from t_11_101_{5} as a  left join t_11_101_{6} as b  on a.C001 = b.C001 left join T_11_006_{7} as c on a.C011 = c.C001 " +
