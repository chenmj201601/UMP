...
//        All rights reserved
//        guid1:                    6e6f8353-4bc4-4886-bc48-a2491a1632a8
...
//        File Name:                Window
//
//        created by Charley at 2014/4/1 16:29:38
...
namespace VoiceCyber.CustomControls
{
    ...
    public class Window:System.Windows.Window
    {
        ...
        private Point mMousePoint; //鼠标坐标
        ...
        public Window()
        {
            mWindowResouce.Source = new Uri("VCCustomControls;component/Window.xaml", UriKind.Relative);
        ...
        private void WindowBase_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            this.SizeChanged += (s1, e1) =>
            {
                ...
                else if (mMaxButton.Style != mWindowResouce["WinMaxButton"]
