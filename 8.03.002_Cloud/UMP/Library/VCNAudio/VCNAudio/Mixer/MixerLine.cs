...
//        All rights reserved
//        guid1:                    f8fbe404-b6d5-4dfb-8ad2-eed91087e556
...
//        File Name:                MixerLine
//
//        created by Charley at 2014/12/8 14:47:15
...
namespace VoiceCyber.NAudio.Mixer
{
    ...
    public class MixerLine
    {
        ...
        public IEnumerable<MixerControl> Controls
        {
            get
            {
                return MixerControl.GetMixerControls(mixerHandle, this, mixerHandleType);
            }
        }
