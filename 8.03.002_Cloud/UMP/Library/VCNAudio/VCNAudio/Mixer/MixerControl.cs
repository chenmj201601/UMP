...
//        All rights reserved
//        guid1:                    70605ea0-5336-41e0-9d69-eb565bd92889
//        CLR Version:              4.0.30319.18444
//        Name:                     MixerControl
//        Computer:                 CHARLEY-PC
//        Organization:             VoiceCyber
//        Namespace:                VoiceCyber.NAudio.Mixer
//        File Name:                MixerControl
//
//        created by Charley at 2014/12/8 14:43:06
...
namespace VoiceCyber.NAudio.Mixer
{
    ...
    public abstract class MixerControl
    {
        ...
        public bool IsBoolean
        {
            get
            {
                return IsControlBoolean(mixerControl.dwControlType);
            }
        }
        ...
        public bool IsListText
        {
            get
            {
                return IsControlListText(mixerControl.dwControlType);
            }
        }
        ...
        public bool IsSigned
        {
            get
            {
                return IsControlSigned(mixerControl.dwControlType);
            }
        }
        ...
        public bool IsUnsigned
        {
            get
            {
                return IsControlUnsigned(mixerControl.dwControlType);
            }
        }
        ...
        public bool IsCustom
        {
            get
            {
                return IsControlCustom(mixerControl.dwControlType);
            }
        }
