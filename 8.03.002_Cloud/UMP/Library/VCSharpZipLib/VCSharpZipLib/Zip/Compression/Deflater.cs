...
//        All rights reserved
//        guid1:                    99fa7105-6f4d-444c-8645-3839d04933c9
...
//        File Name:                Deflater
//
//        created by Charley at 2015/7/22 16:52:25
...
namespace VoiceCyber.SharpZips.Zip.Compression
{
    ...
    public class Deflater
    {
		...
		*/
        ...
        {
            if (intlevel == DEFAULT_COMPRESSION)
            {
                intlevel = 6;
            }
            else if (intlevel < NO_COMPRESSION || intlevel > BEST_COMPRESSION)
            {
                throw new ArgumentOutOfRangeException("intlevel");
            }

            if (level != intlevel)
            {
                level = intlevel;
                engine.SetLevel(intlevel);
            }
        }
