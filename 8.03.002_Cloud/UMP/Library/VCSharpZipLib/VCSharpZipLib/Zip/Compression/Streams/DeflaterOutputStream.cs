...
//        All rights reserved
//        guid1:                    48875073-39cc-4069-bc61-99c636dcb5cd
//        CLR Version:              4.0.30319.18063
//        Name:                     DeflaterOutputStream
//        Computer:                 CHARLEY-PC
//        Organization:             VoiceCyber
//        Namespace:                VoiceCyber.SharpZips.Zip.Compression.Streams
//        File Name:                DeflaterOutputStream
//
//        created by Charley at 2015/7/22 16:50:55
...
using VoiceCyber.SharpZips.Encryption;
...
namespace VoiceCyber.SharpZips.Zip.Compression.Streams
{
    ...
    public class DeflaterOutputStream : Stream
    {
        ...
        /// <summary>
        /// Initializes encryption keys based on given <paramref name="strPassword"/>.
        /// </summary>
        /// <param name="strPassword">The password.</param>
        protected void InitializePassword(string strPassword)
        {
#if NETCF_1_0
			keys = new uint[] {
				0x12345678,
            ...
            byte[] key = PkzipClassic.GenerateKeys(ZipConstants.ConvertToArray(strPassword));
