...
namespace Common2400
{
    ...
    /// 用于与数据库做交互
    /// </summary>
    public class UMPEncryptionPolicy
    {
        public UMPEncryptionPolicy()
        {
        ...
        private string _PolicyRent;

        /// <summary>
        /// 策略所属租户
        /// </summary>
        public string PolicyRent
        {
            get { return _PolicyRent; }
            set { _PolicyRent = value; }
        }
        ...
        private string _TypeUStartTime;

        /// <summary>
        /// 在修改用户输入的策略类型时 保存新开始生效时间
        /// </summary>
        public string TypeUStartTime
        {
            get { return _TypeUStartTime; }
            set { _TypeUStartTime = value; }
        }
        ...
        /// <summary>
        /// 将EncryptionPolicy对象转成list<string> 用于传送给wcf  用于添加
        /// </summary>
        /// <param name="policy"></param>
        /// <returns></returns>
        public static List<string> ObjectToListStringForAdd(UMPEncryptionPolicy policy)
        {
        ...
        /// <summary>
        /// 将EncryptionPolicy对象转成list<string> 用于传送给wcf  用于修改
        /// </summary>
        /// <param name="policy"></param>
        /// <returns></returns>
        public static List<string> ObjectToListStringForModify(UMPEncryptionPolicy policy)
        {
            List<string> lstStrs = new List<string>();
            try
            {
                lstStrs.Add("00000");   //此值不用
                lstStrs.Add(policy.PolicyID);
                lstStrs.Add(policy.PolicyName);
                lstStrs.Add(policy.TypeUStartTime);
                lstStrs.Add(policy.TypeuEncryptKey);
                lstStrs.Add(policy.DurationEnd);
                lstStrs.Add(policy.BeginDayofCycle);
                lstStrs.Add(policy.ResetCycle);
