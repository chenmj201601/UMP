...
//        All rights reserved
//        guid1:                    d0d83561-56ae-47d1-8b17-c29f9c1c8750
...
//        File Name:                ZipEntry
//
//        created by Charley at 2015/12/29 10:01:10
    ...
    public class ZipEntry : ICloneable
    {
        ...
        internal void ProcessExtraData(bool localHeader)
        {
            ...
            else if (extraData.Find(0x5455))
            {
                ...
                int readByte = extraData.ReadByte();

                // Can include other times but these are ignored.  Length of data should
                // actually be 1 + 4 * no of bits in flags.
                if (((readByte & 1) != 0) && (length >= 5))
                {
        ...
        /// <remarks>
        /// The Zip name class is more flexible.
        /// </remarks>
