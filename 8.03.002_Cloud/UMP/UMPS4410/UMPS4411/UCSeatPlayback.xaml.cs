        ...
        private void UpdateExtItemState()
        {
            try
            {
                ...
                if (stateInfo != null)
                {
                    ...
                    {
                        strStatus += string.Format("{0}; ", (LoginState)stateInfo.State);
                ...
                if (stateInfo != null)
                {
                    if (stateInfo.State > 0)
                    {
                        strStatus += string.Format("{0}; ", (CallState)stateInfo.State);
                ...
                if (stateInfo != null)
                {
                    if (stateInfo.State > 0)
                    {
                        strStatus += string.Format("{0}; ", (RecordState)stateInfo.State);
                ...
                if (stateInfo != null)
                {
                    if (stateInfo.State > 0)
                    {
                        strStatus += string.Format("{0}; ", (DirectionState)stateInfo.State);
                        strDirection = string.Format("{0}", (DirectionState)stateInfo.State);
                    }
                }
                stateInfo =
                ...
                if (stateInfo != null)
                {
                    if (stateInfo.State > 0)
                    {
                        strStatus += string.Format("{0}; ", (AgentState)stateInfo.State);
                    }
                }
