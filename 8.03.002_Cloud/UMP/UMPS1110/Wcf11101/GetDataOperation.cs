    ...
    public partial class Service11101
    {
        ...
        private OperationReturn GetResourceObjectList(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                 ...
                 *      Other02：C002（策略类型，1 归档策略；2 回删策略）
                 *      Other10：C012（备注信息）
                 * 
                 */
