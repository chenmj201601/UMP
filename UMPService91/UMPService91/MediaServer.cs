...
//        All rights reserved
//        GUID1:                    661d2511-46ad-49ca-b67d-4aeb2e950d6d
...
//
//        Created by Charley at 2016/8/18 10:21:25
...
namespace UMPService91
{
    public class MediaServer : IEncryptable, INetServer
    {
        ...
        public const int DATA_PORT = 4525;
        public const string CERT_PASSWORD = "VoiceCyber,123";
        ...
        private PolicyServer mPolicyServer;
        ...
        public List<INetSession> ListSessions
        {
        ...
        public void Stop()
        {
            try
            {
                ...
                if (mPolicyServer != null)
                {
                    mPolicyServer.StopSocketServer();
                }
                mPolicyServer = null;
                StopListener();
        ...
        private void StartPolicyServer()
        {
            try
            {
                ...
                mPolicyServer = null;
                mPolicyServer = new PolicyServer();
                mPolicyServer.Debug += OnDebug;
                mPolicyServer.StartSocketServer();

                OnDebug(LogMode.Info, string.Format("PolicyServer started"));
            }
            catch (Exception ex)
            {
                OnDebug(LogMode.Error, string.Format("StartPolicyServer fail.\t{0}", ex.Message));
            }
        }
            ...
            try
            {
                ...
                switch (command)
                {
                    case ConstValue.MONITOR_COMMAND_GETSESSIONINFO:
                        ...
                        break;
                    case Service91Consts.MONITOR_COMMAND_GETRESOURCEOBJECT:
