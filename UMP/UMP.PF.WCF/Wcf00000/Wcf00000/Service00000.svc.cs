    ...
    public class Service00000 : IService00000
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (AListStringArgs[4] == "A")
                    {
                        ...
                        for (int LIntAddRow = 1; LIntAddRow <= 3; LIntAddRow++)
                        {
                    ...
                    for (int LIntLoopSaveItem = 7; LIntLoopSaveItem < LIntAllSaveItem; LIntLoopSaveItem++)
                    {
                        ...
                        if (LIntPropertyID > 20 && LIntPropertyID <= 30) { LIntPropertyRow = 2; LStrColumnName = "C" + (LIntPropertyID - 10).ToString("000"); }
        ...
        private OperationDataArgs OperationA52(List<string> AListStringArgs)
        {
            ...
            try
            {
                ...
                LStrVerificationCode104 = CreateVerificationCode(EncryptionAndDecryption.UMPKeyAndIVType.M104);
                string strConn = EncryptionAndDecryption.EncryptDecryptString(AListStringArgs[1],
                    LStrVerificationCode104, EncryptionAndDecryption.UMPKeyAndIVType.M104);
                LDBOperationReturn = LDBDataOperations.SelectDataByDynamicSQL(int.Parse(AListStringArgs[0]), strConn, LStrDynamicSQL);
