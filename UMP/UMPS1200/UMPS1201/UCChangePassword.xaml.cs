    ...
    public partial class UCChangePassword
    {
        ...
        void BtnConfirm_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                listArgs.Add(App.Session.LoginInfo.LoginID.ToString());
        ...
        private bool CheckInput()
        {
            try
            {
                ...
                string strPass = App.DecryptString(App.Session.UserInfo.Password);
                if (!strOldPass.Equals(strPass))
                {
                    ShowException(App.GetLanguageInfo("S0000038", "Old password error!"));
                    return false;
                }
