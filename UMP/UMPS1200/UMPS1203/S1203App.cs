...
//        All rights reserved
//        guid1:                    9446227c-cc4a-44f7-9e71-9fd855cf61fd
...
//        File Name:                S1203App
//
//        created by Charley at 2016/1/22 12:06:11
...
namespace UMPS1203
{
    public class S1203App : UMPApp
    {
        ...
        public S1203App(bool runAsModule)
            : base(runAsModule)
        {

        }

        public S1203App(IRegionManager regionManager,
        ...
        protected override void InitSessionInfo()
        {
            ...
            appServerInfo.Address = "192.168.6.46";
        ...
        protected override void OnGlobalSettingChanged(WebRequest webRequest)
        {
            base.OnGlobalSettingChanged(webRequest);
            ...
            try
            {
                ...
                switch (strName)
                {
                    case ConstValue.GS_KEY_PARAM_ROLE:
                        var view = CurrentView as PageHeadNewView;
                        if (view != null)
                        {
                            view.Reload();
                        }
        ...
        protected override void SetView()
        {
            ...
            CurrentView=new PageHeadNewView();
            CurrentView.PageName = "PageHeadNewView";
        }
