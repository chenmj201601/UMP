    ...
    public partial class Service11011
    {
        private OperationReturn AddNewOrgInfo(SessionInfo session, string strOrgInfo)
        {
            ...
            try
            {
                ...
                bool IsTenantOrg = newOrgInfo.ParentID.ToString() == string.Format("101{0}00000000001", session.RentInfo.Token);
                switch (session.DBType)
                {
                    ...
                    case 2:
                        DbParameter[] mssqlParameters =
                        {
                            ...
                            MssqlOperation.GetDbParameter("@ainparam13",MssqlDataType.Varchar,1024),
                        ...
                        if (IsTenantOrg)
                        {
                            mssqlParameters[13].Value = "1";
                        }
                        else
                        {
                            mssqlParameters[13].Value = "0";
                        }
                        mssqlParameters[14].Value = errNum;
                        mssqlParameters[15].Value = errMsg;
                        mssqlParameters[13].Direction = ParameterDirection.Output;
                        mssqlParameters[14].Direction = ParameterDirection.Output;
                        mssqlParameters[15].Direction = ParameterDirection.Output;
                        ...
                        if (mssqlParameters[14].Value.ToString() != "0")
                        {
                            if (mssqlParameters[14].Value.ToString() == "-1")
                            {
                                //同名机构名称
                                optReturn.Result = false;
                                optReturn.Code = Defines.RET_DBACCESS_EXIST;
                                optReturn.Message = mssqlParameters[15].Value.ToString();
                            }
                            else
                            {
                                optReturn.Result = false;
                                optReturn.Code = Defines.RET_DBACCESS_FAIL;
                                optReturn.Message = string.Format("{0}\t{1}", mssqlParameters[14].Value, mssqlParameters[15].Value);
                            }
                        }
                        else
                        {
                    ...
                    case 3:
                        DbParameter[] orclParameters =
                        {
                            ...
                            OracleOperation.GetDbParameter("ainparam13",OracleDataType.Varchar2,1024),
                        ...
                        if (IsTenantOrg)
                        {
                            orclParameters[13].Value = "1";
                        }
                        else
                        {
                            orclParameters[13].Value = "0";
                        }
                        orclParameters[14].Value = errNum;
                        orclParameters[15].Value = errMsg;
                        orclParameters[13].Direction = ParameterDirection.Output;
                        orclParameters[14].Direction = ParameterDirection.Output;
                        orclParameters[15].Direction = ParameterDirection.Output;
                        ...
                        if (orclParameters[14].Value.ToString() != "0")
                        {
                            if (orclParameters[14].Value.ToString() == "-1")
                            {
                                //同名机构名称
                                optReturn.Result = false;
                                optReturn.Code = Defines.RET_DBACCESS_EXIST;
                                optReturn.Message = orclParameters[15].Value.ToString();
                            }
                            else
                            {
                                optReturn.Result = false;
                                optReturn.Code = Defines.RET_DBACCESS_FAIL;
                                optReturn.Message = string.Format("{0}\t{1}", orclParameters[14].Value, orclParameters[15].Value);
                            }
                        }
                        else
                        {
