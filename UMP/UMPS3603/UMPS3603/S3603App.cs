...
namespace UMPS3603
{
    public struct PaperInfoParam
    {
        public CPaperParam PaperParam;
        public S3603Codes OptType;
    }

    class S3603App : UMPApp
    {
       
        public S3603App(bool runAsModule)
            : base(runAsModule)
        {

        }

        public S3603App(IRegionManager regionManager,
        ...
        public static PaperInfoParam GPaperInfoParamo = new PaperInfoParam();
        /// <summary>
        /// 分组管理方式，E虚拟分机，A座席，R真实分机；
        /// </summary>
        public static string GroupingWay;

        public static TestInfoParam GTestInformation = new TestInfoParam();
        public static CPaperParam GPaperParam = new CPaperParam();
        #endregion
        ...
        protected override void InitSessionInfo()
        {
            ...
            serverInfo.Address = "192.168.6.29";
...
//             Session.DBConnectionString = dbInfo.GetConnectionString();
        ...
        protected override void SetView()
        {
            ...
            CurrentView.PageName = "ExaminationManagement";
        }
