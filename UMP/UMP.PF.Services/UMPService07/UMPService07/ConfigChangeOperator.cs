...
//        All rights reserved
//        guid1:                    50044af8-af9a-4f0e-ba98-f637f6129f2f
...
//
//        created by Charley at 2015/11/24 13:44:07
    ...
    public class ConfigChangeOperator
    {
        ...
        private void CheckConfigChangeWorker(IAsyncResult result)
        {
            ...
            try
            {
                ...
                OnDebug(LogMode.Debug, string.Format("DistHead:{0}\t{1}", distHead.BaseHead, distHead.DataSize));
                ...
                else
                {
                    ...
                    OnDebug(LogMode.Debug, string.Format("AppHead:{0}\t{1}", appHead.Encrypt, appHead.Format));
                    //取出数据区
                    ...
                    OnDebug(LogMode.Debug, string.Format("Data message:{0}", strMsg));
