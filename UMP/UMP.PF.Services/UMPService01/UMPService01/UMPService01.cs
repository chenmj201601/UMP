            ...
            try
            {
                while (IBoolCanContinue)
                {
                    ...
                    if (LStrOperationCode == "M01A01")
                    {
                        ...
                        LStrReplaceArguments = LClientOpArgsAndReturn.LListArguments[1] + AscCodeToChr(30) + AscCodeToChr(30) + AscCodeToChr(30) + "*****";         //使用*****替换密码，by Charley at 2016/11/21
                    }
                    else if (LStrOperationCode == "M01A04")
                    {
                        ...
                        LStrReplaceArguments = GetUserAccountByUserID(LClientOpArgsAndReturn.LListArguments[2], LClientOpArgsAndReturn.LListArguments[1]) + AscCodeToChr(30) + AscCodeToChr(30) + AscCodeToChr(30) + "******" + AscCodeToChr(30) + AscCodeToChr(30) + AscCodeToChr(30) + "******";      //使用*****替换密码，by Charley at 2016/11/21
                    }
                    else
                    {
        ...
        private void UserChangeLoginPassword(string[] AStrArrayChangeInfo)
        {
            ...
            finally
            {
                try
                {
                    ...
                    lock (UMPService01.ILock11901)
                    {
                        UMPService01.IYoungCircleQueueWriteOperation.PushElement(LClientOperationReturn);
                    }
                }
                catch (Exception ex)
                {
                    UMPService01.WriteLog(LogMode.Error, string.Format("WriteOperationLog fail.\t{0}", ex.Message));
                }
            }
        }
