...
namespace UMPService00
{
    public partial class UMPService00 : ServiceBase
    {
        ...
        {
            WriteLog(eventLogEntryType == EventLogEntryType.Error ? LogMode.Error : LogMode.Info, LStrEntryBody);
        }

        internal static void WriteLog(string p, EventLogEntryType eventLogEntryType)
        {
            WriteLog(eventLogEntryType == EventLogEntryType.Error ? LogMode.Error : LogMode.Info, p);
        }
