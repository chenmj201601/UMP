...
namespace UMPService00
{
    public class DecDefine
    {
        ...
        // 数据格式
        static public byte NETPACK_DATA_FORMAT_UNDEFINE = 0;		// 未定义
        static public byte NETPACK_BASEHEAD_VER1_FORMAT_BINARY = 1;		// 二进制数据
        static public byte NETPACK_BASEHEAD_VER1_FORMAT_TEXT_UTF8 = 2;		// TEXT UTF8
        static public byte NETPACK_BASEHEAD_VER1_FORMAT_TEXT_UNICODE =3;		// TEXT UNICODE
        static public byte NETPACK_BASEHEAD_VER1_FORMAT_TEXT_ANSI = 4;		// TEXT ANSI
        static public byte NETPACK_BASEHEAD_VER1_FORMAT_XML = 5;		// XML
        static public byte NETPACK_BASEHEAD_VER1_FORMAT_JSON = 6;		// Json
    ...
    public struct NETPACK_BASEHEAD_APPLICATION_VER1
    {
        ...
        public char[] _reserved;		// 保留,必须清空为0
    }
    #endregion
}
