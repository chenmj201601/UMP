...
//        All rights reserved
//        guid1:                    5574de1a-a423-45e1-a97f-0eec85a4f883
...
//
//        created by Charley at 2015/3/29 21:02:48
        ...
        public OperationReturn Connect(string address, int port)
        {
            ...
            try
            {
                ...
                if (mTcpClient.Connected)
                {
                    ...
                    mStream.AuthenticateAsClient(address, null, SslProtocols.Default, false);
                    mIsConnected = true;
