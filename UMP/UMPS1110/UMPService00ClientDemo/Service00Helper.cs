...
//        All rights reserved
//        guid1:                    fb3d1e44-6610-4faa-ba05-a474c894a726
...
//
//        created by Charley at 2015/2/28 16:06:00
...
namespace UMPService00ClientDemo
{
    public class Service00Helper
    {
        ...
        private const int RECIEVE_TIMEOUT = 100;    //接收消息的超时时间，单位100ms
        private const int CONNECT_TIMEOUT = 60;     //连接维持的最长空闲时间，超过此时间内没有任何请求接收消息则自动关闭连接,单位1m
        ...
        private void CheckConnection()
        {
            try
            {
                while (true)
                {
                    ...
                    if ((now - mLastActiveTime).TotalSeconds > mConnectTimeout)
                    {
                        Close();
                    }
