...
namespace VoiceCyber.UMP.Common11101
{
    public class S1110Consts
    {
        ...
        public const int RESOURCE_SMDRSERVER = 234;
        public const int RESOURCE_SMDRDBB = 235;
        public const int RESOURCE_CMSERVER = 236;
        public const int RESOURCE_CMSERVERVOICE = 237;
        public const int RESOURCE_SMDRSERVERSOURCE = 238;
        public const int RESOURCE_SMDRDBBSOURCE = 239;
        ...
        public const int RESOURCE_BACKUPSTRATEGY = 258;
