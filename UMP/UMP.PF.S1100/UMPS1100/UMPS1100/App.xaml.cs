...
namespace UMPS1100
{
    public partial class App : Application
    {
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            GClassSessionInfo.AppName = "UMPS1100";
        }
        ...
        #region 获取机构类型、技能组数据
        public static void Load11009Data()
        {
        ...
        public static void LoadStyleDictionary()
        {
            ...
            try
            {
                LStrLocalResourcePath = System.IO.Path.Combine(App.GClassSessionInfo.LocalMachineInfo.StrCommonApplicationData, @"UMP.Client\Themes", App.GClassSessionInfo.ThemeInfo.Name, "Style1100.xaml");
