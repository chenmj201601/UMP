...
namespace UMPS3103.Models
{
    public class RecordInfoItem : INotifyPropertyChanged
    {
        ...
        public string StrAbnormalScores { get; set; }
        public int AfterEventProcessing { get; set; }
        public string StrAfterEventProcessing { get; set; }
        public int SeatAgentSpeechAnomaly { get; set; }
        public string StrSeatAgentSpeechAnomaly { get; set; }
        ...
        public RecordInfoItem(RecordInfo recordInfo):this()
        {
            ...
            AbnormalScores = recordInfo.AbnormalScores;
            AfterEventProcessing = recordInfo.AfterEventProcessing;
            SeatAgentSpeechAnomaly = recordInfo.SeatAgentSpeechAnomaly;
        }
