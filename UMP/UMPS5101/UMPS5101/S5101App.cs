...
namespace UMPS5101
{
    class S5101App : UMPApp
    {
        public S5101App(bool runAsModule)
            : base(runAsModule)
        {

        }

        public S5101App(IRegionManager regionManager, IEventAggregator eventAggregator, IAppControlService appController)
        ...
        public static S5101Codes GOptInfo;
