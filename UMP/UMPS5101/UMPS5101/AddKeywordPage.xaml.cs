...
namespace UMPS5101
{
    ...
    public partial class AddKeywordPage
    {
        ...
        {
            base.ChangeLanguage();
            TbKeyword.Text = CurrentApp.GetLanguageInfo("5101T00007", "Ketword");
            TbIcan.Text = CurrentApp.GetLanguageInfo("5101T00023", "Level");
            CbEnableKwConnect.Content = CurrentApp.GetLanguageInfo("5101T00024", "Is the key words cotent");
            CbEnable.Content = CurrentApp.GetLanguageInfo("5101T00025", "Enable");
            ButNext.Content = CurrentApp.GetLanguageInfo("5101T00026", "Enable");
        ...
        private void ButNext_OnClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show(CurrentApp.GetLanguageInfo("5101T00060",
                ...
                switch (CmbIcan.SelectedIndex)
                {
                    case 0:
                        ...
                        _mKwInfo.StrImagePath = "/PublicFiles/S5101/00011.png";
                        break;
                    case 1:
                        _mKwInfo.StrImage = "00012.png";
                        _mKwInfo.StrImagePath = "/PublicFiles/S5101/00012.png";
                        break;
                    case 2:
                        _mKwInfo.StrImage = "00013.png";
                        _mKwInfo.StrImagePath = "/PublicFiles/S5101/00013.png";
                        break;
                    case 3:
                        _mKwInfo.StrImage = "00014.png";
                        _mKwInfo.StrImagePath = "/PublicFiles/S5101/00014.png";
                        break;
                    case 4:
                        _mKwInfo.StrImage = "00015.png";
                        _mKwInfo.StrImagePath = "/PublicFiles/S5101/00015.png";
                        break;
                }
                ...
                if (bEnable)
                {
                    ...
                    S5101App.GLongKeywordNum = _mKwInfo.LongKwNum;
                    OpenEditKwInfoPage();
                }
        ...
        private void OpenEditKwInfoPage()
        {
            ...
            ParentPage.PopupPanel.Title = CurrentApp.GetLanguageInfo("5101T00032", "Edit Content");
        ...
        private long CreateNum()
        {
            try
            {
                if (!S5101App.GQueryModify)
                {
                    ...
                    Service51011Client client = new Service51011Client(WebHelper.CreateBasicHttpBinding(CurrentApp.Session),
        ...
        private bool AddKeyword(KeywordInfoParam keywordInfo)
        {
            try
            {
                ...
                webRequest.Code = (int)S5101Codes.OptAddKeyword;
        ...
        {
            switch (S5101App.GKwInfo.StrImage)
            {
                case "00011.png":
                    CmbIcan.SelectedIndex = 0;
                    break;
