...
namespace Common1600
{
    public enum S1600MessageType
    {
        ...
        EndCookie=12,           //结束会话
        CookieID=13,            //会话ID 新开启的会话 返回会话ID
    }
    ...
    public enum S1600WcfError
    {
        ...
        /// <summary>
        /// 不能与用户聊天，因为他不在您的联系人列表内
        /// </summary>
        NotInContacterList=1600911,
        /// <summary>
        /// 获得会话状态出现异常
        /// </summary>
        GetCookieStatusException=1600912,
        /// <summary>
        /// 获得会话状态出错
        /// </summary>
        GetCookieStatusError=1600913,
    }
