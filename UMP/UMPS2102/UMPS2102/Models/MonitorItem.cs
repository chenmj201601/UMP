...
namespace UMPS2102.Models
{
    public class MonitorItem : INotifyPropertyChanged
    {
        ...
        private string mStrChannelConnected;

        public string StrChannelConnected
        {
            get { return mStrChannelConnected; }
            set { mStrChannelConnected = value; OnPropertyChanged("StrChannelConnected"); }
        }

        private string mStrChannelDisConnected;

        public string StrChannelDisConnected
        {
            get { return mStrChannelDisConnected; }
            set { mStrChannelDisConnected = value; OnPropertyChanged("StrChannelDisConnected"); }
        }
        ...
        public string StrDirection
        {
            ...
            set { mStrDirection = value; OnPropertyChanged("StrDirection"); }
        }
        ...
        private bool mIsChannelConnected;

        public bool IsChannelConnected
        {
            get { return mIsChannelConnected; }
            set { mIsChannelConnected = value; OnPropertyChanged("IsChannelConnected"); }
        }

        private bool mIsChannelDisConnected;

        public bool IsChannelDisConnected
        {
            get { return mIsChannelDisConnected; }
            set { mIsChannelDisConnected = value; OnPropertyChanged("IsChannelDisConnected"); }
        }
        ...
        public void UpdateState()
        {
            ...
            if (Role == 1)
            {
                ...
                if (VoiceChanState != null)
                {
                    ...
                    IsChannelConnected = VoiceChanState.ConnectState == ConnectState.Connected;
                    IsChannelDisConnected = VoiceChanState.ConnectState == ConnectState.DisConnected;
                }
            }
            if (Role == 2)
            {
            ...
            StrChannelConnected = IsChannelConnected
                ? CurrentApp.GetLanguageInfo(string.Format("BID{0}{1}", S2102Consts.BID_CONNECTSTATE, "001"),
                    "Channel Connected")
                : string.Empty;
            StrChannelDisConnected = IsChannelDisConnected
                ? CurrentApp.GetLanguageInfo(string.Format("BID{0}{1}", S2102Consts.BID_CONNECTSTATE, "002"),
