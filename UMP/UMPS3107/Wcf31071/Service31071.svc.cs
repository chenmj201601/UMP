...
namespace Wcf31071
{
    ...
    public partial class Service31071 : IService31071
    {
            ...
            try
            {
                ...
                switch (webRequest.Code)
                {
                    ...
                    case (int)S3107Codes.GetABCD:
                        ...
                        webReturn.ListData = optReturn.Data as List<string>;
                        break;
                    case (int)S3107Codes.GetKeyWordItems:
                        optReturn = GetKeyWordItems(session, webRequest.ListData);
                        if (!optReturn.Result)
                        {
                            webReturn.Result = false;
                            webReturn.Code = optReturn.Code;
                        ...
                        webReturn.ListData = optReturn.Data as List<string>;
                        break;
                    case (int)S3107Codes.GetAgentsTemplate:
                        optReturn = GetAgentsTemplate(session, webRequest.ListData);
                        if (!optReturn.Result)
                        {
                            webReturn.Result = false;
                            webReturn.Code = optReturn.Code;
        ...
        private OperationReturn QuerySettingDBO(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                if(listParams[1]=="F")//F新建，T修改
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(QueryItems.KeyContentOne))
                    {
                        dr["C027"] = QueryItems.KeyContentOne;
                    }
                    if (!string.IsNullOrWhiteSpace(QueryItems.KeyContentTwo))
                    {
                        dr["C028"] = QueryItems.KeyContentTwo;
                    }
                    if (!string.IsNullOrWhiteSpace(QueryItems.KeyContentThree))
                    {
                        dr["C029"] = QueryItems.KeyContentThree;
                    }
                    if (!string.IsNullOrWhiteSpace(QueryItems.LQKeyWordItemsOne))
                    {
                        dr["C030"] = QueryItems.LQKeyWordItemsOne;
                    }
                    if (!string.IsNullOrWhiteSpace(QueryItems.LQKeyWordItemsTwo))
                    {
                        dr["C031"] = QueryItems.LQKeyWordItemsTwo;
                    }
                    if (!string.IsNullOrWhiteSpace(QueryItems.LQKeyWordItemsThree))
                    {
                        dr["C032"] = QueryItems.LQKeyWordItemsThree;
                    }
                    if (!string.IsNullOrWhiteSpace(QueryItems.BookMarkStr))
                    {
                        dr["C033"] = QueryItems.BookMarkStr;
                    }
        ...
        private OperationReturn TaskSettingDBO(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                if (listParams[1] =="F")//F新建，T修改
                {
                    ...
                    dr["C021"] = TaskItems.KeyContentOne;
                    dr["C022"] = TaskItems.KeyContentTwo;
                    dr["C023"] = TaskItems.KeyContentThree;
                    dr["C024"] = TaskItems.LQKeyWordItemsOne;
                    dr["C025"] = TaskItems.LQKeyWordItemsTwo;
                    dr["C026"] = TaskItems.LQKeyWordItemsThree;
                    dr["C027"] = TaskItems.TemplateID;
        ...
        private OperationReturn GetQueryDetail(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                {
                    ...
                    Item.KeyContentOne = GetStringFDB(dr["C027"].ToString());
                    Item.KeyContentTwo = GetStringFDB(dr["C028"].ToString());
                    Item.KeyContentThree = GetStringFDB(dr["C029"].ToString());
                    Item.LQKeyWordItemsOne = GetStringFDB(dr["C030"].ToString());
                    Item.LQKeyWordItemsTwo = GetStringFDB(dr["C031"].ToString());
                    Item.LQKeyWordItemsThree = GetStringFDB(dr["C032"].ToString());
                    Item.BookMarkStr = GetStringFDB(dr["C033"].ToString());
        ...
        private OperationReturn GetTaskDetail(SessionInfo session, List<string> listParams)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                {
                    ...
                    Item.KeyContentOne = GetStringFDB(dr["C021"].ToString());
                    Item.KeyContentTwo = GetStringFDB(dr["C022"].ToString());
                    Item.KeyContentThree = GetStringFDB(dr["C023"].ToString());
                    Item.LQKeyWordItemsOne = GetStringFDB(dr["C024"].ToString());
                    Item.LQKeyWordItemsTwo = GetStringFDB(dr["C025"].ToString());
                    Item.LQKeyWordItemsThree = GetStringFDB(dr["C026"].ToString());
                    if (string.IsNullOrWhiteSpace(dr["C027"].ToString()))
                    {
                        Item.TemplateID = 0;
                    }
                    else
                    {
                        Item.TemplateID = Convert.ToInt64(dr["C027"]);
                    }
        ...
        private OperationReturn GetKeyWordItems(SessionInfo session, List<string> listParams)
        {
            OperationReturn optReturn = new OperationReturn();
            optReturn.Result = true;
            optReturn.Code = 0;
            try
            {
                ...
                switch (session.DBType)
                {
                    case 2:
                        strSql =
                            string.Format(
                                "SELECT A.C001 AS AC001, A.C002 AS AC002, A.C003 AS AC003, B.C001 AS BC001, B.C002 AS BC002 FROM T_51_006_{0} A,"+
                                "T_51_007_{0} B, T_51_008_{0} C WHERE A.C001 = C.C002 AND B.C001 = C.C001 AND A.C005  = '1' AND B.C003 = '1' AND C.C003 = '1'",
                                rentToken);
                        optReturn = MssqlOperation.GetDataSet(session.DBConnectionString, strSql);
                        if (!optReturn.Result)
                        {
                    ...
                    case 3:
                        strSql =
                           string.Format("SELECT A.C001 AS AC001, A.C002 AS AC002, A.C003 AS AC003, B.C001 AS BC001, B.C002 AS BC002 FROM T_51_006_{0} A,"+
                           "T_51_007_{0} B, T_51_008_{0} C WHERE A.C001 = C.C002 AND B.C001 = C.C001 AND A.C005  = '1' AND B.C003 = '1' AND C.C003 = '1'",
                               rentToken);
                        optReturn = OracleOperation.GetDataSet(session.DBConnectionString, strSql);
                        if (!optReturn.Result)
                ...
                for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                {
                    ...
                    KeyWordItems info = new KeyWordItems();
                    info.KeyWordID = Convert.ToInt64(dr["AC001"]);
                    info.KWContentID = Convert.ToInt64(dr["BC001"]);
                    string strName = dr["AC002"].ToString();
                    strName = DecryptString02(strName);
                    info.KeyWordSrt = strName;
                    info.IsUsed = true;
                    //info.Icon = dr["AC003"].ToString();
                    string strContent = dr["BC002"].ToString();
                    strContent = DecryptString02(strContent);
                    info.KWContent = strContent;
        ...
        private OperationReturn GetAgentsTemplate(SessionInfo session, List<string> listParams)
        {
            OperationReturn optReturn = new OperationReturn();
            optReturn.Result = true;
            optReturn.Code = 0;
            try
            {
                ...
                switch (session.DBType)
                {
                    case 2:
                        strSql =
                            string.Format("SELECT * FROM T_31_001_{0} WHERE C010>=CONVERT(DATETIME,'{1}',121) AND C018='Y' ",
                                rentToken, DateTime.Now.ToUniversalTime().ToString("yyyy-MM-dd HH:mm:ss"));
                        optReturn = MssqlOperation.GetDataSet(session.DBConnectionString, strSql);
                        if (!optReturn.Result)
                        {
                            return optReturn;
                    ...
                    case 3:
                        strSql =
                           string.Format("SELECT * FROM T_31_001_{0} WHERE C010>to_date('{1}','YYYY/MM/DD HH24:MI:SS') AND C018='Y' ",
                               rentToken, DateTime.Now.ToUniversalTime().ToString("yyyy-MM-dd HH:mm:ss"));
                        optReturn = OracleOperation.GetDataSet(session.DBConnectionString, strSql);
                        if (!optReturn.Result)
                        {
                ...
                for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                {
                    item = string.Empty;
                    DataRow dr = objDataSet.Tables[0].Rows[i];
                    item = string.Format("{0};{1}",dr["C001"].ToString(),dr["C002"].ToString());
                    listReturn.Add(item);
                }
                optReturn.Data = listReturn;
            }
