...
namespace Common3107
{
    public class TaskSettingItems
    {
        ...
        /// 关键词内容
        /// </summary>
        public string KeyContentOne { get; set; }
        public string KeyContentTwo { get; set; }
        public string KeyContentThree { get; set; }
        /// <summary>
        /// 关键词ID
        /// </summary>
        public string LQKeyWordItemsOne { get; set; }
        public string LQKeyWordItemsTwo { get; set; }
        public string LQKeyWordItemsThree { get; set; }
