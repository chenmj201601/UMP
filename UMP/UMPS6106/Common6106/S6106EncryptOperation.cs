...
{
    public class S6106EncryptOperation
    {
        ...
        public static string DecryptLL256(string AStrSource)
        {
            ...
            byte[] LByteArrayKey256Low1 = Encoding.ASCII.GetBytes(S6106Const.VCT_KEY256_LOW1);
            byte[] LByteArrayAexIv = Encoding.ASCII.GetBytes(S6106Const.VCT_ENCRYPTION_AES_IVEC_LOW);
