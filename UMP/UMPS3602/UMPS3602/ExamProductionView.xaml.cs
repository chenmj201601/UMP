...
namespace UMPS3602
{
    ...
    public partial class ExamProductionView
    {
        ...
        private readonly List<CPaperParam> _mListPaperParamsAll;
        ...
        public ExamProductionView()
        {
            ...
            _mListPaperParamsAll = new List<CPaperParam>();
        ...
        private void CancelSpeech_Click(object sender, RoutedEventArgs e)
        {
            ...
            _mPageCount = 0;
            _mbListViewEnable = true;
            foreach (var param in _mListPaperParamsAll)
            {
        ...
        private void DeletePaper_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (DeletePaper())
            {
                ...
                foreach (var paperParam in _mListPaperParams)
                {
                    ...
                    _mListPaperParamsAll.Remove(_mListPaperParamsAll.FirstOrDefault(p=>p.LongNum == paperParam.LongNum));
                    int total = _mQuestionNum - 1;
                    if (total > _mMaxInfos)
                    {
                        ShowInformation(CurrentApp.GetLanguageInfo("3602T00147", "Larger than allowed max Questions, some Questions can\'t be displayed"));
        ...
        private void GetAllPaperInfos()
        {
            try
            {
                ...
                for (int i = 0; i < webReturn.ListData.Count; i++)
                {
                    ...
                    _mListPaperParamsAll.Add(cExamPapers);
                    SetPageState();
                }
                SetObservableCollection();
        ...
        public void AddPaperList()
        {
            if (S3602App.GPaperInfo.OptType == S3602Codes.OptAddPaper)
            {
                ...
                _mListPaperParamsAll.Insert(0, _mAddPaperInfo.PaperParam);
            }
            else
            {
                ...
                _mListPaperParamsAll.Remove(
                    _mListPaperParamsAll.FirstOrDefault(p => p.LongNum == S3602App.GPaperInfo.PaperParam.LongNum));
                _mListPaperParamsAll.Insert(0, S3602App.GPaperInfo.PaperParam);
            }
            SetObservableCollection();
        }
