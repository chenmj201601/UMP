...
namespace VoiceCyber.Wpf.CustomControls.Charts
{
    ...
    public class ValueExtractor : Freezable
    {
        ...
        private static void OnItemsChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (oldItems != null)
                ((INotifyCollectionChanged)oldItems).CollectionChanged -= v.OnItemsCollectionChanged;

            if (v != null && v.Items != null)
            {
                ((INotifyCollectionChanged)v.Items).CollectionChanged += v.OnItemsCollectionChanged;
                if (v.ValuePath != null)
                    v.GenerateValueList();
            }
        }
        ...
        public static readonly DependencyProperty ItemsProperty =
            DependencyProperty.Register("Items", typeof(ItemCollection), typeof(ValueExtractor), new FrameworkPropertyMetadata(null, OnItemsChanged));
        ...
        public static readonly DependencyProperty ValuePathProperty =
            DependencyProperty.Register("ValuePath", typeof(PropertyPath), typeof(ValueExtractor), new FrameworkPropertyMetadata(null, OnValuePathChanged));
