...
//        All rights reserved
//        guid1:                    3d4995c9-88b3-4ddb-b5c2-6e8733fb4829
...
//
//        created by Charley at 2014/4/5 16:38:26
...
{
    /// <summary>
    /// GridTree的绑定对象，GridTree的ItemsSource必须继承此类型
    /// </summary>
    public class GridTreeItem : ICheckableTreeItem, IIconTreeItem
    {
        ...
        public GridTreeItem(string name)
            : this()
        {
            mName = name;
            mLevel = 0;
