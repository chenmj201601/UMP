...
//        All rights reserved
//        guid1:                    ffb8169d-1506-44b6-ac6c-6cbeabe2668e
//        CLR Version:              4.0.30319.18444
//        Name:                     AiffFileReader
//        Computer:                 CHARLEY-PC
//        Organization:             VoiceCyber
//        Namespace:                VoiceCyber.NAudio.Wave
//        File Name:                AiffFileReader
//
//        created by Charley at 2014/12/8 16:16:08
...
namespace VoiceCyber.NAudio.Wave
{
    ...
    public class AiffFileReader : WaveStream
    {
        ...
        public override int Read(byte[] array, int offset, int count)
        {
            ...
            {
                throw new ApplicationException(String.Format("Must read complete blocks: requested {0}, block align is {1}", count, WaveFormat.BlockAlign));
            }
