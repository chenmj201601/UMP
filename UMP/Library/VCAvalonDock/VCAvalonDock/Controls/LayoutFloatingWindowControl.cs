...
//        All rights reserved
//        guid1:                    e970bf6c-ea12-4a7a-860e-530300273d22
//        CLR Version:              4.0.30319.18444
//        Name:                     LayoutFloatingWindowControl
//        Computer:                 CHARLEY-PC
//        Organization:             VoiceCyber
//        Namespace:                VoiceCyber.Wpf.AvalonDock.Controls
//        File Name:                LayoutFloatingWindowControl
//
//        created by Charley at 2014/7/22 10:08:54
...
using VoiceCyber.Wpf.AvalonDock.Themes;
...
namespace VoiceCyber.Wpf.AvalonDock.Controls
{
    public abstract class LayoutFloatingWindowControl : Window, ILayoutControl
    {
        ...
        {
            CommandBindings.Add(new CommandBinding(Windows.Shells.SystemCommands.CloseWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Windows.Shells.SystemCommands.CloseWindow((Window)args.Parameter))));
            CommandBindings.Add(new CommandBinding(Windows.Shells.SystemCommands.MaximizeWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Windows.Shells.SystemCommands.MaximizeWindow((Window)args.Parameter))));
            CommandBindings.Add(new CommandBinding(Windows.Shells.SystemCommands.MinimizeWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Windows.Shells.SystemCommands.MinimizeWindow((Window)args.Parameter))));
            CommandBindings.Add(new CommandBinding(Windows.Shells.SystemCommands.RestoreWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Windows.Shells.SystemCommands.RestoreWindow((Window)args.Parameter))));
