...
//        All rights reserved
//        guid1:                    da0aef90-b7a6-4b9b-88ca-e24379bf30cb
...
//        File Name:                Arrays
//
//        Created by Charley at 2016/9/30 16:18:26
...
namespace VoiceCyber.NPOI.Util
{
    public class Arrays
    {
        ...
        public static String DeepToString(Object[] a)
        {
            ...
            DeepToString(a, buf, new Collections.HashSet<Object[]>());
            return buf.ToString();
        }

        private static void DeepToString(Object[] a, StringBuilder buf,
                                        Collections.HashSet<Object[]> dejaVu)
        {
            if (a == null)
            {
                buf.Append("null");
