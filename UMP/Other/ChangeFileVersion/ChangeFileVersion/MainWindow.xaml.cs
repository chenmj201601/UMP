...
namespace ChangeFileVersion
{
    ...
    public partial class MainWindow
    {
        ...
        {
            mRootPath = @"F:\Charley\TNSVNRoot\8.03.002\UMP";
            mBuildNo = 1;
        ...
        private void ReplaceText(string fileName)
        {
            if (fileName.EndsWith("AssemblyInfo.cs"))
            {
                ...
                string strReplaced = string.Format("[assembly: AssemblyVersion(\"8.3.2.{0}\")]",
                    mBuildNo);

                string strReplaced2;
                if (mIsWithDate)
                {
                    strReplaced2 = string.Format("[assembly: AssemblyFileVersion(\"8.03.002.{0}({1})\")]",
                        mBuildNo.ToString("000"),
                        DateTime.Now.ToString("yyyyMMdd"));
                }
                else
                {
                    strReplaced2 = string.Format("[assembly: AssemblyFileVersion(\"8.03.002.{0}\")]",
                        mBuildNo.ToString("000"));
                }

                string strReplaced3 = string.Format("[assembly: AssemblyCopyright(\"Copyright © 2016 VoiceCyber Technologies Ltd.\")]");
