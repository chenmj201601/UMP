...
namespace UMPUpdater
{
    ...
    public partial class App
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            //LoadAllLanguages();
            StartupUri = new Uri("UpdateWindow.xaml", UriKind.RelativeOrAbsolute);
            base.OnStartup(e);
        }
        ...
        private void SaveUMPDataZip()
        {
            try
            {
                string strMsg = string.Format("Begin Save UMPData.zip...");
                ...
                strMsg = string.Format("Save UMPData.zip end.");
                Console.WriteLine(strMsg);
            }
            catch (Exception ex)
            {
        ...
        private void ExtractUMPData()
        {
            try
            {
                string strMsg = string.Format("Begin Extract UMPData.zip...");
                Console.WriteLine(strMsg);
                ...
                strMsg = string.Format("Extract UMPData.zip end.");
                Console.WriteLine(strMsg);
            }
            catch (Exception ex)
            {
