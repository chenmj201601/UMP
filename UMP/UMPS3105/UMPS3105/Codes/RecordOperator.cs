    ...
    public class RecordOperator
    {
        ...
        public OperationReturn GetRealPassword(RecordEncryptInfo encryptInfo)
        {
            ...
            try
            {
                ...
                strError = ((S3105App)CurrentApp).DecryptString(strError);
                ...
                strKey1B = ((S3105App)CurrentApp).DecryptString(strKey1B);
                encryptInfo.RealPassword = strKey1B;
                OnDebug("GetRealPass",
                    string.Format("Get real password end.\t{0}", ((S3105App)CurrentApp).EncryptString(strKey1B)));
            }
            catch (Exception ex)
            {
                optReturn.Result = false;
